...
<div class="container py-5">
    <div class="jumbotron" style="background: linear-gradient(to right, rgba(139, 0, 0, 0.05), rgba(165, 42, 42, 0.05));">
        ...
        <p class="lead">A comprehensive platform for course and instructor evaluations to enhance the quality of education at Eastern Visayas State University - Ormoc City Campus. (Pray always)</p>
        <hr class="my-4">
