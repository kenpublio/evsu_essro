    ...
    updatePrintLink();
            ...
            <div class="table-card">
                ...
                <div style="margin-bottom: 20px; display: flex; gap: 10px; align-items: center; flex-wrap: wrap;">
                    ...
                    <div>
                        <select id="ratingFilter" class="form-control" style="width: auto;">
                    ...
                    <div>
                        <span id="filterCount" style="color: #666; font-size: 0.85rem;"></span>
                    </div>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table" id="evaluationsTable">
                        ...
                        <tbody id="tableBody">
                            ...
                            <tr class="evaluation-row" data-student="<?php echo strtolower(htmlspecialchars($row['fullname'] ?? $row['username'] ?? '')); ?>" 
                                data-student-id="<?php echo strtolower(htmlspecialchars($row['student_id'] ?? '')); ?>"
                                data-question="<?php echo strtolower(htmlspecialchars($row['question_text'] ?? '')); ?>"
                                data-rating="<?php echo $row['rating'] ?? 0; ?>"
                                ...
                                <td><div class="rating-stars"><?php for ($i = 1; $i <= 5; $i++): ?><?php if ($i <= ($row['rating'] ?? 0)): ?><i class="fas fa-star"></i><?php else: ?><i class="far fa-star"></i><?php endif; ?><?php endfor; ?></div></td>
                                <td><?php if (!empty($row['answer'])): ?><span class="badge badge-info">With comment</span><?php else: ?><span class="badge" style="background:#e9ecef;">No comment</span><?php endif; ?></td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
                ...
                <div style="text-align: center; margin-top: 20px;"><a href="evaluations.php" class="btn btn-outline">View All Evaluations</a></div>
                <?php endif; ?>
            </div>
        </main>
    </div>
