...
// Get recent evaluations based on selected service
...
// 1. Rating Distribution for Chart
$rating_labels = ['1 Star', '2 Stars', '3 Stars', '4 Stars', '5 Stars'];
$rating_data = [];
for ($i = 1; $i <= 5; $i++) {
    $count = $conn->query("SELECT COUNT(*) as count FROM responses WHERE rating = $i")->fetch_assoc()['count'];
    $rating_data[] = $count;
}

// 2. Monthly Evaluation Trends (Last 6 months)
$monthly_labels = [];
$monthly_counts = [];
for ($i = 5; $i >= 0; $i--) {
    ...
    $count = $conn->query("SELECT COUNT(*) as count FROM responses WHERE DATE_FORMAT(submitted_at, '%Y-%m') = '$month'")->fetch_assoc()['count'];
...
$service_labels = [];
$service_ratings = [];
$services_chart = $conn->query("SELECT st.name, AVG(r.rating) as avg_rating 
    FROM responses r 
    JOIN service_types st ON r.service_type_id = st.id 
    WHERE r.rating > 0 
    GROUP BY st.id 
    ORDER BY avg_rating DESC");
while ($row = $services_chart->fetch_assoc()) {
    $service_labels[] = $row['name'];
    $service_ratings[] = round($row['avg_rating'], 1);
}
    ...
    <div class="main-layout">
        ...
        <main class="main-content">
            ...
            <div class="quick-actions">
                ...
                <a href="javascript:void(0)" class="quick-action-card" onclick="showExportModal()">
            ...
            <div class="charts-row">
                ...
                <div class="chart-card">
                    <h3><i class="fas fa-chart-line"></i> Monthly Evaluation Trends</h3>
                    <div class="chart-container">
            ...
            <div class="chart-card" style="margin-bottom: 25px;">
                <h3><i class="fas fa-chart-bar"></i> Service Performance by Rating</h3>
                ...
                <?php if (!empty($recent_evaluations)): ?>
                    ...
                    <?php if (count($recent_evaluations) >= 20): ?>
                        <div style="text-align: right; margin-top: 20px;">
                            <a href="report.php" style="color: var(--evsu-red); text-decoration: none;">
...
<div id="exportModal" class="export-modal">
    <div class="export-modal-content">
        <div class="export-modal-header">
            <h3><i class="fas fa-download"></i> Export Evaluation Data</h3>
            <button type="button" class="close-modal" onclick="closeExportModal()">&times;</button>
        </div>
        <div class="export-modal-body">
            <form id="exportForm" action="export_report.php" method="GET" target="_blank">
                <div class="form-group">
                    <label><i class="fas fa-tag"></i> Select Service Type:</label>
                    <select name="service" class="form-control" required>
                        <option value="0">All Services</option>
                        <?php
                        $services_export = $conn->query("SELECT * FROM service_types WHERE is_active = 1 ORDER BY name");
                        while($s = $services_export->fetch_assoc()):
                        ?>
                ...
                <div class="form-group">
                    <label><i class="fas fa-calendar-alt"></i> Report Type:</label>
                ...
                <div class="form-group" id="custom_group" style="display: none;">
                    ...
                    <div style="display: flex; gap: 10px;">
                        <input type="date" name="date_from" class="form-control" placeholder="From" value="<?php echo date('Y-m-01'); ?>">
                        <input type="date" name="date_to" class="form-control" placeholder="To" value="<?php echo date('Y-m-t'); ?>">
                    </div>
                </div>
    ...
    <footer class="footer">
        <div class="footer-links">
            ...
            <a href="../logout.php" onclick="return confirm('Are you sure you want to logout?');">
                <a class="fas fa-sign-out-alt"></a> Logout
            </a>
        </div>
        <div class="copyright">
    ...
    new Chart(serviceCtx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: <?php echo json_encode($service_ratings); ?>,
    ...
    // ============================================
    // EXPORT MODAL FUNCTIONS (ONLY ONCE)
    // ============================================
    ...
    // Toggle between monthly and custom date range
    ...
    // Animation delay for stat cards
