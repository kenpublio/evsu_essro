...
$total_unique_query = "SELECT COUNT(DISTINCT CONCAT(user_id, '-', DATE(submitted_at), '-', IFNULL(service_type_id, 0))) as total FROM responses WHERE user_id = ?";
$stmt = $conn->prepare($total_unique_query);
$stmt->bind_param("i", $user_id);
$stmt->execute();
$total_unique = $stmt->get_result()->fetch_assoc()['total'];
$stmt->close();

// Calculate statistics
$stats = [
    'total_evaluations' => $total_unique,
...
$page_title = 'Student Evaluation Portal';
?>
<!-- Then your HTML code continues... -->
    ...
    <header class="evsu-header">
        <div class="header-container">
            ...
            <div class="header-right">
                ...
                <a href="history.php" class="logout-link history-link">
    ...
    <div class="main-container">
        ...
        <div class="welcome-card">
            <h2>
                ...
                Hello, <?php echo isset($_SESSION['fullname']) ? $_SESSION['fullname'] : (isset($_SESSION['username']) ? $_SESSION['username'] : 'Student'); ?>!
                <?php if(isset($_SESSION['role']) && $_SESSION['role'] == 'student'): ?>
                <br><small>Student Account</small>
                <?php endif; ?>
            </h2>
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card" onclick="window.location.href='history.php'" style="cursor: pointer;">
                <div class="stat-icon">
                ...
                <div class="stat-content">
                    ...
                    <div class="stat-sub">Click to view history →</div>
                </div>
            </div>
        ...
        <div class="registrar-card">
            ...
            <?php if ($evaluated_today): ?>
                ...
                <div class="button-container">
                    ...
                    <a href="history.php" class="evaluate-btn btn-history">
                        <i class="fas fa-history"></i> View Evaluation History
                    </a>
                </div>
            <?php else: ?>
                <div class="button-container">
        ...
        <div class="info-card">
            ...
            <div class="tips-grid">
                ...
                <div class="tip-item" onclick="window.location.href='history.php'" style="cursor: pointer;">
                    <i class="fas fa-history" style="color: #17a2b8;"></i>
                    <span>View your evaluation history</span>
                </div>
            </div>
        </div>
